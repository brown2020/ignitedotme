...
const Terms: NextPage = () => {
  return (
    <>
      ...
      <div className="container flex flex-col  px-2 py-5 mx-auto space-y-3 sm:px-5">
        <h2 className="text-center">Terms of Service</h2>

        <p>
          Welcome and thank you for your interest in Ignite Channel services and
          mobile apps! These Terms of Use (the “Agreement”) describe the terms and
          conditions applicable to your use of Ignite.me, the Ignite.me film
          pages, Energize.me, CharmXR.app, Chill.me (the “Sites”) and the related
          mobile applications (the “Mobile Apps”) (collectively, the “Services”).
          The Sites and Mobile Apps are owned and operated by Ignite Channel Inc,
          and its affiliates and subsidiaries (collectively “Ignite Channel” or
          “Ignite”).
        </p>
        <p>
          In this Agreement, we refer to ourselves as “Ignite” or “us” or “we”; we
          refer to you as “you” or “Customer.” Ignite and Customer are referred to
        ...
        <p>
          ...
          of this Agreement and the Privacy Policy (available at{" "}
          <a className="link-light" href="https://ignite.me/privacy">
            ignite.me/privacy
          </a>
        ...
        <p>
          Ignite grants you a limited license to access the Sites subject to this
          Agreement. If you choose to subscribe to and use the Mobile Apps, Ignite
          further grants you a license to access and use the Services, subject to
          and conditioned upon your compliance with this Agreement, the Privacy
          Policy, and any other rules and requirements communicated to you by
          Ignite, including your payment of any applicable fees. You acknowledge
          and agree that Ignite may modify, update, and otherwise change the
        ...
        <p>
          ...
          repairs which Ignite may undertake from time to time without notice to
          you; or (iii) causes which are beyond the control of Ignite or which are
          not reasonably foreseeable.
        </p>
        <p>
          Notwithstanding anything to the contrary in this Agreement, Ignite may
          temporarily suspend access to the Services provided to you and any other
          third-party for security purposes, to prevent illegal or fraudulent
          activity, to comply with the requests of any legal agency or government
          entity, or if you violate the Agreement or the Privacy Policy.
        </p>
        <p>
          Ignite may from time to time and in its sole discretion engage other
          service providers to assist in the performance of the Services, such as
          web hosting providers, payment processors, and other third-parties. You
          shall abide by the terms of use and other requirements associated with
          the services provided by such third-parties in connection with the
          Services.
        </p>
        ...
        <p>
          ...
          backup devices or services, and any other requirements. Ignite shall
          have no responsibility to provide any additional Mobile Apps or
          hardware. You further agree that Ignite shall have no responsibility for
          any data loss or other damage or loss suffered in connection with your
          use of the Services, including any failure to provide adequate security
          or backup devices or services.
        </p>
        <p>
          You are responsible for ensuring Ignite has accurate and current
        ...
        <p>
          ...
          other security information. You shall notify Ignite immediately of any
          unauthorized access to or use of your Credentials or any other breach of
          security. Ignite has the right to disable any username, password,
          credentials file, or other identifier at any time, whether chosen by you
          or provided by Ignite.
        </p>
        <p>
          Ignite shall make commercially reasonable efforts to provide adequate
          support services for the Services. Notwithstanding the foregoing, this
          Agreement does not entitle you to any guaranteed level, availability, or
          turnaround time of support services for the Services.
        </p>
        ...
        <p>
          ...
          reason, and Ignite reserves the sole discretion to determine which
          Services or portions thereof require payment.
        </p>
        <p>
          ...
          to, the date of payment of your Pre-Order fee and Ignite’s production
        ...
        <p>
          You authorize Ignite to charge your designated payment method for Paid
          Services. By providing an acceptable payment method, you represent and
          warrant that you are authorized to use the designated payment method and
          that you authorize us or our third-party payment processor to charge
        ...
        <p>
          ...
          suspended or terminated by Ignite. Unless otherwise indicated by us,
          your designated payment method will be charged prior to, or at the
        ...
        <p>
          ...
          subscription and automatic payment, click on the “Cancel Account” button
          from your account screen or email us at support@ignitechannel.com.
          Cancellation does not entitle you to the refund of any previously paid
          Fees and you will not receive a prorated refund for the remainder of the
          Subscription Term. In the event you cancel your Subscription, note that
          we may still send you promotional communications, unless you opt out of
          receiving those communications by following the unsubscribe instructions
        ...
        <p>
          Ignite reserves the right to adjust the Fees for our Paid Services, or
          any features or parts of our Paid Services, at any time. You acknowledge
          that Ignite may change the Fees for Paid Services at any time. In the
          event of such a change, Ignite will provide notice to you via the email
          address associated with your account at least thirty (30) days in
          advance of the effective date of the change. Your continued use of the
          Services indicates your acceptance of any changes to the Fees. You are
          solely responsible for all applicable taxes, and will be charged for
          taxes when required by law.
        </p>
        <h5>Data and Communications</h5>
        <p>
          Ignite may collect and process information regarding your usage of the
          Services. You consent to Ignite’s collection and use of such
          information, as well as the sharing of such information with third-party
          service providers for purposes of providing, marketing, and improving
          the Services, and any other reason described in the Privacy Policy. All
          personal information collected by Ignite is treated in accordance with
          the{" "}
        ...
        <p>
          ...
          your contact information to Ignite, you give your express consent to
          allow Ignite, its affiliates, and agents to contact you from time to
          time at any mailing address, phone number, or email address you provide
          to Ignite. Your consent means you agree to be contacted by Ignite and
          its service providers via phone, email, text message, or other means for
          any purpose, including but not limited to notifications related to the
          Services and your account, subscriptions, purchases, available upgrades,
          billing and payment processing issues, and telemarketing communications.
          Such authorized communications may include use of automated dialing
          technology or the use of pre-recorded messages. You are responsible for
          any charges that may be billed to you by your service provider(s) when
          we contact you. You further acknowledge that your consent to the
          foregoing is not a condition of using the Ignite Services, and if you do
          not wish to consent, you may contact us and request to be placed on a do
          not contact list, or you may opt out any time using the opt-out
          mechanism provided in any such communications.
        </p>
        <p>
          Ignite disclaims all liability under this Agreement for any information
          you provide to Ignite that may constitute electronic patient health
          records or similar information supplied by you or an end user,
          notwithstanding anything to the contrary in this Agreement or as
          otherwise required by any applicable federal, state, or international
          laws, rules, or regulations.
        </p>
        <h5>Intellectual Property Rights</h5>
        <p>
          Ignite Channel, Ignite, Tally.fit, Chill.me, and CharmXR are trademarks
          of Ignite Channel Inc. Ignite Content, Ignite products, Ignite features
          and Services, and our underlying technology are protected by copyright,
          trademark, patent, intellectual property, and other laws of the United
          States and foreign countries. All rights reserved. You are not granted,
          by implication or otherwise, any license or right to use any marks
          appearing on, or used or displayed in connection with, the Services
          (“Trademarks”). The Services may also contain or refer to third-party
          trademarks, trade names, product names, and logos that may be registered
          trademarks of their respective owners. Under no circumstances may you
          use or copy any of the Trademarks. Nothing herein should be construed as
          granting any license or right to use any Trademarks displayed in
          connection with the Services without Ignite’s express written
          permission.
        </p>
        <p>
          ...
          licensed by or to Ignite and are protected by U.S. and international
          copyright laws. You agree you will not directly or indirectly copy,
          reproduce, modify, create derivative works from, distribute, or publicly
          display the Copyrighted Works without the prior express written
          permission of Ignite.
        </p>
        <p>
          If you provide any communications or materials to Ignite by mail, email,
          ...
          (“Feedback”), Ignite is free to use such Feedback irrespective of any
          other obligation or limitation between the Parties governing such
          Feedback. Ignite is free to use, without any attribution or compensation
          to any party, any ideas, know-how, concepts, techniques, or other
          intellectual property rights contained in the Feedback, for any purpose
          whatsoever, although Ignite is not required to use any Feedback.
        </p>
        <p>
          Ignite respects the intellectual property rights of others and it is our
          policy to expeditiously process and review notices of claimed
          infringement of copyright or other applicable intellectual property
          laws. Any notices of claimed infringement should be sent to Ignite’s
          Designated Agent at ip@ignitechannel.com, and must contain all of the
          following: (i) a signature (physical or electronic) of the copyright
          owner or a person authorized to act on behalf of the copyright owner;
          (ii) a description of the copyrighted work that you claim has been
          infringed; (iii) a description of the material that you claim is
          infringing and is to be removed or have access to same disabled, and
          information sufficient to permit Ignite’s administrators to locate the
          material; (iv) information sufficient for us to contact you, such as
          address, telephone number, and email address; (v) a statement that you
        ...
        <p>
          ...
          AVAILABLE” WITHOUT WARRANTY OF ANY KIND, AND IGNITE AND ITS
          ...
          AND NON-INFRINGEMENT. IGNITE DOES NOT WARRANT AGAINST INTERFERENCE WITH
          YOUR ENJOYMENT OF THE SERVICES, THE AVAILABILITY OF CONTENT, THAT THE
          FUNCTIONS CONTAINED IN THE SERVICES WILL MEET YOUR REQUIREMENTS, THAT
          THE SERVICES WILL BE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS, THAT
          THE OPERATION OF THE SERVICES WILL BE UNINTERRUPTED OR ERROR-FREE, THAT
          DEFECTS IN THE SERVICES WILL BE CORRECTED, OR THAT THE FUNCTIONS
          CONTAINED IN THE SERVICES WILL FUNCTION WITH OTHER MOBILE APPS OR
          HARDWARE, OR WITHIN A SYSTEM. NO ORAL OR WRITTEN INFORMATION OR ADVICE
          GIVEN BY IGNITE OR AN IGNITE AUTHORIZED REPRESENTATIVE SHALL CREATE A
        ...
        <p>
          IN NO EVENT WILL IGNITE, ITS SUBSIDIARIES, AFFILIATES, OFFICERS,
          ...
          REGARDLESS OF WHETHER OR NOT IGNITE HAS BEEN WARNED OF THE POSSIBILITY
          OF SUCH DAMAGES.
        </p>
        <p>
          ...
          OR LIMITED AS SET FORTH ABOVE, IN NO EVENT SHALL IGNITE BE LIABLE FOR
          ANY CLAIM, WHETHER IN CONTRACT, TORT, OR UNDER ANY OTHER THEORY OF
          LIABILITY, IN EXCESS OF $100.
        </p>
        <h5>Precautions</h5>
        <p>
          THE SERVICES ARE NOT A MEDICAL DEVICE AND YOU EXPRESSLY AGREE THAT THE
          SERVICES DO NOT INVOLVE THE PROVISION OF MEDICAL ADVICE BY IGNITE. THE
          SERVICES ARE NOT INTENDED TO DIAGNOSE, TREAT, CURE, OR PREVENT ANY
          DISEASE OR MEDICAL CONDITION. THE SERVICES ARE FOR INFORMATIONAL
          PURPOSES ONLY AND CANNOT REPLACE THE SERVICES OF PHYSICIANS OR MEDICAL
          PROFESSIONALS.
        </p>
        <p>
        ...
        <p>
          ...
          OR OTHER HEALTHCARE PROFESSIONAL RELATIONSHIP BETWEEN YOU AND IGNITE.
        </p>
        <p>
        ...
        if you have any questions regarding a medical condition. Ignite is not
        responsible for any health problems that may result from information you
        learn about through the Services. If you make any change to your sleep
        or activity based on the Services, you agree that you do so fully at
        your own risk. It is important to be sensitive to your body's responses.
        For example, if you feel unexpected, repeating, or long-term pain, or
        fatigue or discomfort due to having made changes to your sleep or
        activity, it is recommended that you consult a physician before
        continuing with such changes. The information in the Services may be
        misleading if your physiological functions and responses differ
        significantly from population averages due to medical conditions or rare
        natural differences.`}
        </p>
        <p>
          ...
          relationship, or sponsorship by Ignite with respect to the provider of
          such linked site or the quality, reliability, or any other
          characteristic or feature of such linked site. You further acknowledge
          and agree that Ignite is not responsible in any manner (including
          ...
          or with Ignite. Ignite may not even be aware that a third party has
          linked to the Services.
        </p>
        <p>
          Any other content not owned by Ignite is owned by its respective owner.
          You acknowledge and agree that such content is provided by its owner and
          does not reflect any endorsement, affiliation, relationship, or
          sponsorship by Ignite with respect to the provider of such content. You
          further acknowledge and agree that Ignite is not liable or responsible
          in any manner (including without limitation with respect to any loss or
          injury you may suffer) for any content provided by third parties
          including, without limitation, your reliance thereon. IGNITE MAKES NO
          REPRESENTATIONS OR WARRANTIES WITH RESPECT TO ANY THIRD PARTY CONTENT.
        </p>
        <p>
          You agree to indemnify, hold harmless, and defend Ignite, its
          subsidiaries, affiliates, officers, directors, employees,
        ...
        <h5>Termination; Cancellation</h5>
        <p>
          This Agreement shall continue in full force until terminated or canceled
          pursuant to this Agreement.
        </p>
        <p>
          Ignite shall have the right to terminate this Agreement (i) for any
          reason whatsoever by providing thirty (30) days’ notice to you; (ii)
          ...
          the foregoing, Ignite reserves the right, in its sole discretion and
          without notice, at any time and for any reason, to remove, modify,
        ...
        <p>
          ...
          thirty (30) days’ notice to Ignite by email at
          support@ignitechannel.com. You shall be responsible for all Fees
        ...
        <h5>Federal Government End Use Restrictions</h5>
        <p>
        ...
        <h5>Export Compliance and Use Restrictions</h5>
        <p>
        ...
        relationship with Ignite shall be governed by, construed, and
        ...
        local laws of the consumer's country. The English language shall govern
        all documents, notices, and interpretations of these Agreement. You also
        agree to waive any right to assert any claims against Ignite as a
        representative or member in any class or representative action, except
        where such waiver is prohibited by law or deemed by a court of law to be
        against public policy.`}
        </p>
        <h5>Miscellaneous</h5>
        <p>
          You acknowledge that Ignite has the right to monitor use of the Services
        ...
        <p>
          ...
          exclusive statement of the agreement between you and Ignite regarding
          the Services, and supersedes any and all prior or contemporaneous
        ...
        <h5>Modification of the Terms and Services</h5>
        <p>
          Ignite reserves the right to update this Agreement and/or the Privacy
          Policy at any time and for any reason in its sole discretion by posting
          updated terms. Unless otherwise indicated by Ignite, any changes will
          become effective on a prospective basis from the date of posting. Ignite
          will notify you of any material changes to the Agreement or Services. By
          continuing to access or use the Services after we have provided you with
          notice of a modification, you are agreeing to be bound by the modified
          Agreement. If the modified Agreement is not acceptable to you, your only
          recourse is to cease using the Services. Ignite and its third-party
          service providers may make improvements and/or changes in the Services,
          features, and prices described at any time and for any reason in its
          sole discretion. The Mobile Apps may download and install upgrades,
          updates, and additional features in order to improve, enhance, and
          further develop the Services. Ignite reserves the right at any time to
          modify or discontinue, temporarily or permanently, the Services or any
          portion thereof with or without notice. You agree that Ignite shall not
          be liable to you or to any third party for any modification, suspension,
          or discontinuance of the Services.
        </p>
        <p className="fst-italic">Last Updated: July 14, 2022</p>
      </div>
