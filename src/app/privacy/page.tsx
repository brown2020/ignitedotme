...
const Privacy: NextPage = () => {
  return (
    <>
      ...
      <div className="container flex flex-col  px-2 py-5 mx-auto mb-5 space-y-3 sm:px-5">
        <h2 className="text-center">Privacy Policy</h2>

        <p>
          Protecting your private information is our priority. This Statement of
          Privacy applies to Ignite Channel, Ignite.me, the Ignite Channel film
          pages and apps developed by Ignite Channel and governs data collection
          and usage. For the purposes of this Privacy Policy, unless otherwise
          noted, all references to Ignite include Ignite Channel, the Ignite
          Channel film pages, Ignite.me and apps developed by Ignite Channel Inc,
          including augmented reality applications. By using the Ignite Channel
        ...
        <p>
          ...
          Ignite may collect personally identifiable information, such as your:
        </p>
        <ul>
        ...
        <p>
          Ignite collects and uses your personal information to operate and
          deliver the services you have requested.
        </p>
        <p>
          Ignite may also use your personally identifiable information to inform
          you of other products or services available from Ignite and its
          affiliates.
        </p>
        <h5>Sharing Information with Third Parties</h5>
        <p>
          Ignite does not sell, rent or lease its customer lists to third parties.
        </p>
        <p>
          Ignite may share data with trusted partners to help perform statistical
          ...
          your personal information except to provide these services to Ignite,
          and they are required to maintain the confidentiality of your
          information.
        </p>
        <p>
          Ignite may disclose your personal information, without notice, if
          ...
          process served on Ignite or the site; (b) protect and defend the rights
          or property of Ignite; and/or (c) act under exigent circumstances to
          protect the personal safety of users of Ignite, or the public.
        </p>
        ...
        <p>
          Ignite does not knowingly collect personally identifiable information
        ...
        <p>
          From time to time, Ignite may contact you via email for the purpose of
          providing announcements, promotional offers, alerts, confirmations,
          surveys, and/or other general communication. If you would like to stop
          receiving marketing or promotional communications via email from Ignite,
          you may opt out of such communications by clicking the unsubscribe link
          in the email message.
        </p>
        <h5>External Data Storage</h5>
        <p>
        ...
        <p>
          Ignite reserves the right to change this Privacy Policy from time to
        ...
        <p>
          Ignite welcomes your questions or comments regarding this Statement of
          Privacy. If you believe that Ignite has not adhered to this Statement,
          please contact Ignite at:
        </p>
        <p>
          Ignite Channel Inc.
          <br />
          30765 Pacific Coast Hwy, Suite 354
          <br />
