    ...
    return (
        <div className="flex flex-col flex-1 w-full" id="home">
            ...
            <Slider {...settings} className="slider-block">
                <div className="relative h-screen -mt-16 w-full main-slider-section">
                    <video
                        ref={videoRef}
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center w-full h-full text-contant-section z-10">
                        <div className="flex flex-col max-w-4xl pt-1">
                            <h1 className="text-center font-black hero_title wow animate__animated animate__zoomIn">IGNITE</h1>
                ...
                <div className="relative h-screen -mt-16 w-full main-slider-section">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center w-full h-full text-contant-section z-10">
                        <div className="flex flex-col max-w-4xl pt-1">
                            <h1 className="text-center font-black hero_title">IGNITE</h1>
                            <p className="mx-5 text-center hero_details">
                                Ignite Channel produces and distributes innovative documentary
                                films and media technology.{" "}
                                <span className="underline cursor-pointer" onClick={() => scrollToSection("film")}>Check out</span>
                                {" "}
            ...
            <div className="mt-5 mb-2 pt-5 pb-2" id="film">
                <div className="container mx-auto">
                    <h1 className="text-center  text-4xl text-title relative text-white capitalize section-title  wow animate__animated animate__fadeInDown">Film</h1>
                    <p className="text-center mt-3 pt-5 w-full max-w-3xl m-auto text-white text-2xl  p-2">Exploring the human experience through documentary features on art,
            ...
            <div className="mt-5 mb-2 pt-5 pb-2" id="talks">
                <h1 className="text-center  text-title relative text-white capitalize text-white wow animate__animated animate__fadeInDown">Talks</h1>
                <p className="text-center mt-3 pt-5 w-full  max-w-3xl m-auto text-white text-2xl p-2">Inspiring ideas on technology, AI, and film: Keynotes and TEDx talks
            ...
            <div className="mt-5 mb-2 pt-5 pb-2" id="apps">
                <h1 className="text-center  text-title relative text-white capitalize wow animate__animated animate__fadeInDown">Apps</h1>
                <p className="text-center mt-3 pt-5 w-full  max-w-3xl m-auto text-white text-2xl p-2">Discover apps from self-development to augmented reality, designed to
            ...
            <div className="mt-5 mb-2 pt-5 pb-2" id="openSource">
                <h1 className="text-center  text-title relative text-white capitalize wow animate__animated animate__fadeInDown " data-wow-duration="2s">Open Source</h1>
                <p className="text-center mt-3 pt-5 w-full  max-w-3xl m-auto text-white text-2xl p-2">Empowering creativity through collaboration: Explore, contribute, and
