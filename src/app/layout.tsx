  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css?family=Zain"
          rel="stylesheet"
        ></link>
        <link
          href="https://fonts.googleapis.com/css?family=Anek Latin"
          rel="stylesheet"
        ></link>
      </head>
      <body
        className={`${nunito.className} flex flex-col min-h-screen w-full text-slate-50`}
      >
        <InitAos />
