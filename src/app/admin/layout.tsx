...
const AdminLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  if (!hidePanel) {
    return (
      <AuthGuard authArray={noPanelPaths}>
        <div
          className={`flex h-screen main-admin-section ${
            darkMode ? "dark" : ""
          }`}
        >
          <aside
          ...
          >
            ...
            <nav className="mt-6">
              <Link
                href="/admin/film"
                className={`block py-2 px-6 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white ${
                  pathname === "/admin/film"
    ...
    return <AuthGuard authArray={noPanelPaths}>{children}</AuthGuard>;
  }
};
